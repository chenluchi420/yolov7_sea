...
source_img_folder = r"D:\Yun\sea_trash\corrupt_data\train\images"
source_label_folder = r"D:\Yun\sea_trash\corrupt_data\train\labels"
...
for i in tqdm(range(file_count)):
    ...
    source_label_file = source_label_folder+ "\\"+ file_img_name+ ".txt"
